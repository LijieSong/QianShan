package com.example.bjlz.qianshan.DatePicker;
...
//	private int mTopLineColor = Color.parseColor("#CCE4F2");
	private int mTopLineColor = CommonUtil.getColor(R.color.devide_line);
	//下横线颜色
//	private int mBottomLineColor = Color.parseColor("#CCE4F2");
	private int mBottomLineColor = CommonUtil.getColor(R.color.devide_line);
	//周一到周五的颜色
//	private int mWeedayColor = Color.parseColor("#1FC2F3");
	private int mWeedayColor = CommonUtil.getColor(R.color.color_off);
	//周六、周日的颜色
//	private int mWeekendColor = Color.parseColor("#fa4451");
	private int mWeekendColor = CommonUtil.getColor(R.color.feedback_tab_title_selected);
	//线的宽度
