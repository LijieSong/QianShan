...
/**
 * WaveProgressView  水波纹进度条
 * Created by slj on 2016/7/22.
 */
...
//    private String mTextColor = "#FFFFFF";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        CurX = width = MeasureSpec.getSize(widthMeasureSpec);
...
//        float CurMidX = width*(maxProgress-currentProgress)/maxProgress;
//        if (CurX >CurMidX){
//            CurX = CurX-(CurX-CurMidX)/10;
//        }
//        mPath.reset();
//        mPath.moveTo(0-distance,CurX);
//
//        int waveNum = width/((int)mWaveHalfWidth*4)+1;
//        int multiplier = 0;
//        for(int i =0;i<waveNum*3;i++){
//            mPath.quadTo(mWaveHalfWidth*(multiplier+1)-distance,CurY-mWaveHight,mWaveHalfWidth*(multiplier+2)-distance,CurX);
//            mPath.quadTo(mWaveHalfWidth*(multiplier+3)-distance,CurY+mWaveHight,mWaveHalfWidth*(multiplier+4)-distance,CurX);
//            multiplier+=4;
//        }
