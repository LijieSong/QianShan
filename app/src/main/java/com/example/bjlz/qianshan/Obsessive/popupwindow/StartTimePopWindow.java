		...
		public void onScrollingFinished(WheelView wheel) {
			...
			if (BlueToothActivity.message[4] != 0){
				switch (BlueToothActivity.message[4]){
					case 1:
						BlueToothActivity.message[5] = (byte)n_hour;
						BlueToothActivity.message[6] = (byte)n_min;
						break;
					case 2:
						BlueToothActivity.message[9] = (byte)n_hour;
						BlueToothActivity.message[10] = (byte)n_min;
						break;
					case 3:
						BlueToothActivity.message[13] = (byte)n_hour;
						BlueToothActivity.message[14] = (byte)n_min;
						break;
					case 4:
						BlueToothActivity.message[17] = (byte)n_hour;
						BlueToothActivity.message[18] = (byte)n_min;
						break;
				}
				Log.e("message_start_hour",(byte) (n_hour)+"");
                Log.e("message_start_min",(byte) (n_min)+"");
