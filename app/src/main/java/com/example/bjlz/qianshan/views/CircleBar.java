...
import com.example.bjlz.qianshan.tools.ChangeAndGetTools.DP2PXTools;
...
public class CircleBar extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        circleStrokeWidth = DP2PXTools.dip2px(getContext(), 10);
        pressExtraStrokeWidth = DP2PXTools.dip2px(getContext(), 2);
        mTextSize = DP2PXTools.dip2px(getContext(), 40);
    ...
    public void setPressed(boolean pressed) {
        ...
        LogUtils.error("call setPressed ");
        if (pressed) {
