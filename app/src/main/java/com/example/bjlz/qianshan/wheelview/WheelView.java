...
package com.example.bjlz.qianshan.wheelview;
...
import com.example.bjlz.qianshan.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// The number of first item_grideview in layout
	...
	/**
	 * Sets the current item_grideview. Does nothing when index is wrong.
	 * 
	 * @param index the item_grideview index
	...
	/**
	 * Sets the current item_grideview w/o animation. Does nothing when index is wrong.
	 * 
	 * @param index the item_grideview index
	 */
	...
	/**
	 * Tests if wheel is cyclic. That means before the 1st item_grideview there is shown the last one
	...
	/**
	 * Returns height of wheel item_grideview
	 * @return the item_grideview height
	 */
	...
	/**
	 * Creates item_grideview layouts if necessary
	 */
	...
	/**
	 * Adds view for item_grideview to items layout
	 * @param index the item_grideview index
	 * @param first the flag indicates if view should be first
	 * @return true if corresponding item_grideview exists and is added
	 */
	 ...
	 * @param index the item_grideview index
	 * @return true if item_grideview index is not out of bounds or the wheel is cyclic
	 */
	...
	/**
	 * Returns view for specified item_grideview
	 * @param index the item_grideview index
	 * @return item_grideview view or empty view if index is out of bounds
	 */
