...
//        requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
    ...
    public void initView() {
        ...
        this.title_bar.setTitleText(R.string.device_list);
    ...
    private void doDiscovery() {
        if (D) LogUtils.debug("doDiscovery()");
        // Indicate scanning in the title
        setProgressBarIndeterminateVisibility(true);
        setTitle(R.string.scanning_bluetooth);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // When discovery is finished, change the Activity title
                ...
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    ...
                    ToastUtil.shortDiyToast(getApplicationContext(),getResources().getText(R.string.none_found).toString());
                    finish();
                }
            }
        }
