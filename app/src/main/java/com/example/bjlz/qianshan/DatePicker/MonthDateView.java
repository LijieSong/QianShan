...
//	private int mCurrentColor = Color.parseColor("#ff0000");
	private int mCurrentColor = CommonUtil.getColor(R.color.red);
...
//	private int mCircleRadius = 37;
	...
	protected void onDraw(Canvas canvas) {
		...
		int weekNumber = DataUtils.getFirstDayWeek(mSelYear, mSelMonth);
...
//				canvas.drawCircle(startRecX+67, startRecY+37,mCircleRadius , mPaint);
				//记录第几行，即第几周
				weekRow = row + 1;
			}
			//绘制事务圆形标志
