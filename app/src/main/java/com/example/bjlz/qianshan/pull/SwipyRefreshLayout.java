package com.example.bjlz.qianshan.pull;
 ...
 * provide accessibility events; instead, a menu item_grideview must be provided to allow
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    // Whether this item_grideview is scaled up rather than clipped
...
//    }
    ...
    private void animateOffsetToStartPosition(int from, AnimationListener listener) {
        if (mScale) {
            // Scale the item_grideview back down
...
//            progress.setVisibility(VISIBLE);
            mProgress.setVisible(true,true);
